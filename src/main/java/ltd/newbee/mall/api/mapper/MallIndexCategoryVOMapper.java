...
@Component
public class MallIndexCategoryVOMapper {
    ...
    public CategoryInfoVo mapI18nLangFromEntity(CategoryInfoVo vo, GoodsCategory category, String lang) {
        ...
        switch (lang) {
            case Constants
                    .I18N_LANG_EN: vo.setCategoryName(category.getCategoryEnName());break;
            case Constants
                    .I18N_LANG_CA: vo.setCategoryName(category.getCategoryCaName());break;
            default:
